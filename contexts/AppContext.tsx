...
import { calculateFundCompletely, runAllComplianceChecks } from '../logic/fundEngine.js'; 
...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const saveState = useCallback(() => {
    try {
      const stateToSave = { ...state, isLoading: undefined, error: undefined };
